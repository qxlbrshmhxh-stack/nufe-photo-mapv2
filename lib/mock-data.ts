...
export const mockSpots: Spot[] = [
  {
    ...
    tips: [
      "Shoot from the lowest step for stronger symmetry",
      "Use a 50mm lens for natural portraits",
      "Arrive early before foot traffic increases"
    ],
    previewImage:
  ...
  },
  {
    ...
    tips: [
      "Wait for still water after light wind fades",
      "Shoot toward the sun for silhouettes",
      "Try portrait orientation to emphasize reflections"
    ],
    previewImage:
  ...
  },
  {
    ...
    tips: [
      "Stand near the center line when the path is clear",
      "Use backlight in autumn for glowing leaves",
      "Try burst mode for walking shots"
    ],
    previewImage:
  ...
  },
  {
    ...
    tips: [
      "Use the columns to create layered depth",
      "Shoot close to the wall for clean leading lines",
      "Cloudy afternoons give the smoothest light"
    ],
    previewImage:
  ...
  },
  {
    ...
    tips: [
      "Use the rows of seats as graphic lines",
      "Try wide shots for sky-heavy compositions",
      "A white shirt works well against the warm sunset tones"
    ],
    previewImage:
  ...
  },
  {
    ...
    tips: [
      "Shoot slightly off-center to avoid a flat frame",
      "Keep the full arch visible in wide shots",
      "Morning light gives the gate the cleanest contrast"
    ],
    previewImage:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    tips: [
      "Use backlight for translucent petals",
      "Stay close for soft background blur",
      "After light rain, petals on the ground add texture"
    ],
    previewImage:
  ...
  },
  {
    ...
    tips: [
      "Use a tripod for blue hour scenes",
      "Keep the horizon level in wide frames",
      "Shoot just after sunset for richer city colors"
    ],
    previewImage:
...
export const mockUsers: UserProfile[] = [
  {
    ...
    bio: "A campus photography enthusiast sharing favorite shooting spots.",
    role: "user",
    status: "active",
